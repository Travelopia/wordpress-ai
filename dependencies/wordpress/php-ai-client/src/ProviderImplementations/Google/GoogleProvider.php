...
class GoogleProvider extends AbstractApiProvider
{
    ...
    protected static function createModel(ModelMetadata $modelMetadata, ProviderMetadata $providerMetadata): ModelInterface
    {
        ...
        if (in_array('image_generation', $capabilitiesStringList, \true)) {
    ...
    {
        return new ProviderMetadata('google', 'Google', ProviderTypeEnum::cloud(), 'https://aistudio.google.com/app/api-keys', RequestAuthenticationMethod::apiKey());
    }
    /**
     * {@inheritDoc}
     *
