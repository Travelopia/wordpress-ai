...
namespace Travelopia\WordPress_AI\Dependencies\WordPress\AiClient\Providers\DTO;
...
class ProviderModelsMetadata extends AbstractDataTransferObject
{
    ...
    {
        return ['type' => 'object', 'properties' => [self::KEY_PROVIDER => ProviderMetadata::getJsonSchema(), self::KEY_MODELS => ['type' => 'array', 'items' => ModelMetadata::getJsonSchema(), 'description' => 'The available models for this provider.']], 'required' => [self::KEY_PROVIDER, self::KEY_MODELS]];
    }
    /**
     * {@inheritDoc}
     *
    ...
    public static function fromArray(array $array): self
    {
        ...
        return new self(ProviderMetadata::fromArray($array[self::KEY_PROVIDER]), array_map(static fn(array $modelData): ModelMetadata => ModelMetadata::fromArray($modelData), $array[self::KEY_MODELS]));
    }
}
