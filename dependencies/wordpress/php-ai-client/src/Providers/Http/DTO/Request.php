...
namespace Travelopia\WordPress_AI\Dependencies\WordPress\AiClient\Providers\Http\DTO;
...
use Travelopia\WordPress_AI\Dependencies\WordPress\AiClient\Providers\Http\Collections\HeadersCollection;
...
class Request extends AbstractDataTransferObject
{
     ...
     */
    public function __construct(HttpMethodEnum $method, string $uri, array $headers = [], $data = null, ?RequestOptions $options = null)
    {
        if (empty($uri)) {
    ...
    public static function fromArray(array $array): self
    {
        ...
        return new self(HttpMethodEnum::from($array[self::KEY_METHOD]), $array[self::KEY_URI], $array[self::KEY_HEADERS] ?? [], $array[self::KEY_BODY] ?? null, isset($array[self::KEY_OPTIONS]) ? RequestOptions::fromArray($array[self::KEY_OPTIONS]) : null);
    }
    /**
