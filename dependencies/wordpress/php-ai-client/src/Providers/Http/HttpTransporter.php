...
namespace Travelopia\WordPress_AI\Dependencies\WordPress\AiClient\Providers\Http;

use Travelopia\WordPress_AI\Dependencies\Http\Discovery\Psr17FactoryDiscovery;
use Travelopia\WordPress_AI\Dependencies\Http\Discovery\Psr18ClientDiscovery;
...
use Travelopia\WordPress_AI\Dependencies\WordPress\AiClient\Providers\Http\Contracts\ClientWithOptionsInterface;
...
use Travelopia\WordPress_AI\Dependencies\WordPress\AiClient\Providers\Http\Exception\NetworkException;
/**
...
class HttpTransporter implements HttpTransporterInterface
{
    ...
    public function send(Request $request, ?RequestOptions $options = null): Response
    {
        ...
        } catch (\Travelopia\WordPress_AI\Dependencies\Psr\Http\Client\NetworkExceptionInterface $e) {
            throw NetworkException::fromPsr18NetworkException($psr7Request, $e);
        } catch (\Travelopia\WordPress_AI\Dependencies\Psr\Http\Client\ClientExceptionInterface $e) {
